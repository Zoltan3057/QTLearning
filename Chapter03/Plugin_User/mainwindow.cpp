 ...
 * Function      : QT Load Plugins: QLibrary, QPluginLoader
 *                 Help function realization
 *
 ************************************************************************/
...
{
    // Save plugins in build/filter_plugins
    ...
    // ordered according to the name and attribute filters previously set with setNameFilters()
    // and setFilter(), and sorted according to the flags set with setSorting().
